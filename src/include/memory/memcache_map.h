...
extern Block_t *get_memmap_element(Hash_memmap_ptr map, const char *key);
extern Collisions_list_elem *push_to_memmap(Hash_memmap_ptr map, const char *key, const Block_t *data);
