...
CC = gcc
MY_CCFLAGS = ${CCFLAGS} ${CFLAGS} ${COPT} ${CPPFLAGS} -fPIC -c -Wall -Wpointer-arith -Wendif-labels -Wmissing-format-attribute -Wrestrict -Wimplicit-fallthrough=3 -Wcast-function-type -Wshadow=compatible-local -Wformat-security -fno-strict-aliasing -fwrapv -g -O2 -I$(INCLUDE_PATH)
